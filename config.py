...
ERRBOT_ROOT_DIR = os.path.dirname(os.path.realpath(__file__))
...
BOT_DATA_DIR = ERRBOT_ROOT_DIR + '/data/'
...
BOT_EXTRA_PLUGIN_DIR = ERRBOT_ROOT_DIR + '/plugins/'
...
BOT_EXTRA_BACKEND_DIR = ERRBOT_ROOT_DIR + '/backends/'
...
BOT_LOG_FILE = BOT_DATA_DIR + '/errbot.log'
...
BOT_IDENTITY = {
    # Zulip:
    # Fill this with the corresponding values in your bot's `.zuliprc`
    'email': 'bloop-bot@localhost',
    'key': '----------------',
...
BOT_ADMINS = ('@foo@example.com', 'foo@example.com', '@CHANGE_ME')
...
# BOT_PREFIX = '@**bloop-bot@localhost**'
...
# the prefix above.
BOT_ALT_PREFIXES = ('Ultron ', 'Errbot ', '@**BloopBot** ')
...
DIVERT_TO_PRIVATE = ()  # Doesn't work in Zulip backend
